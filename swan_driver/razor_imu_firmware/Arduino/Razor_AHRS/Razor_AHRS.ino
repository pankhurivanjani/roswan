...
float ACCEL_X_MAX = 255.37;
float ACCEL_Y_MIN = -267.58;
float ACCEL_Y_MAX = 271;
float ACCEL_Z_MIN = -276.25;
float ACCEL_Z_MAX = 269;
...
float magn_ellipsoid_center[3] = {271.146, -647.024, -871.448};
float magn_ellipsoid_transform[3][3] = {{0.900135, -2.88781e-05, -0.00664110}, {-2.88781e-05, 0.915566, 0.0186368}, {-0.00664110, 0.0186368, 0.995444}};
// Gyroscope
// "gyro x,y,z (current/average) = .../OFFSET_X  .../OFFSET_Y  .../OFFSET_Z
float GYRO_AVERAGE_OFFSET_X = 0.025;
float GYRO_AVERAGE_OFFSET_Y = 0.00;
float GYRO_AVERAGE_OFFSET_Z = -0.017;
